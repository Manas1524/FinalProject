...
public class BoardFunctionality {
	...
	private static Map<String, Integer> initializePositionToCoordinateMap() {
        ...
        for (int i = START_TILE_INDEX; i < NUM_TILES; i++) {
            positionToCoordinate.put(makeAlgebreicNotation().get(i), i);
        }
	...
	{
		return initializePositionToCoordinateMap().get(position);
	}
	...
	{
		return makeAlgebreicNotation().get(coordinate);
	}
